...
class ReactNativeCamera extends React.Component {
    state = {
        flash: 'off',
        zoom: 0,
        autoFocus: 'on',
...
const ReactNativeCameraRoutes = createStackNavigator(
    {
        ReactNativeCamera: ReactNativeCamera
    },
    {
        headerMode: 'none',
        initialRouteName: 'ReactNativeCamera',
    }
);

export default ReactNativeCameraRoutes
