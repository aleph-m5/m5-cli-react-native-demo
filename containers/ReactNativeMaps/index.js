...
type Props = {};
class ReactNativeMaps extends React.Component<Props> {
  constructor(props) {
    super(props);
...
const ReactNativeMapsRoutes = createStackNavigator(
    {
        ReactNativeMaps: ReactNativeMaps
    },
    {
        initialRouteName: 'ReactNativeMaps',
    }
);

export default ReactNativeMapsRoutes
